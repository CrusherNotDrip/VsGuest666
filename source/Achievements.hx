...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Ill hack you",                "Beat Week 666 on Hard with no Misses.",            'week666_nomiss',       false],
		["Ah man im a noob, IM MAD",    "Beat Week Bacon on Hard with no Misses.",          'weekbacon_nomiss',     false]
	];
